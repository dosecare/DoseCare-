...
DoseCareV2Database.register({
  ...
  regimens: [
    {
      id: 'clinical-weight-based-6-to-23-months',
      type: 'mg_per_kg_per_dose',
      condition: 'Ibuprofen dosing in children 6–23 months',
      minAgeMonths: 6,
      maxAgeMonths: 23,
      minDose: 5,
      maxDose: 10,
      ...
      interval: 'Every 6–8 hours as needed',
      intervalHours: 6,
      maximumDosesPer24Hours: 4,
      maxDailyDose: 40,
      requiresAge: true,
      requiresWeight: true,
      notes: 'DailyMed clinical labeling supports 5 mg/kg for fever when baseline temperature is below 102.5°F (39.2°C), or 10 mg/kg when baseline temperature is 102.5°F (39.2°C) or higher, for children 6 months up to 2 years; analgesia is 10 mg/kg every 6–8 hours. Maximum recommended daily dose is 40 mg/kg. Select the dose within this range according to the clinical indication and temperature when applicable.'
    },
    {
      ...
      noMatchingBandMessage: 'No labeled OTC dose band matches this age/weight. For children 6 months up to 2 years, use the configured clinical regimen only when clinically appropriate and verify the product labeling.'
    }
  ],
  information: {
    ...
    notes: 'Shake well before use. Use the labeled dosing chart and an appropriate dosing device. Do not exceed 4 doses in 24 hours. The clinical regimen is for children 6 months and older and should be selected according to indication and relevant clinical factors.'
  },
  sources: [
