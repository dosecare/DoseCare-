...
window.DoseCareV2Database?.register({
  ...
  route: 'Oral',
  formulations: [
    { id: '10g-15mL', display: '10 g/15 mL (667 mg/mL)', concentration: { amount: 10, unit: 'g', volume: 15, volumeUnit: 'mL' }, mgPer5mL: 3333.33 }
  ],
  regimens: [
    {
  ...
  information: {
    ...
    mechanism: 'Lactulose is a synthetic disaccharide that is metabolized by colonic bacteria to low-molecular-weight acids, increasing osmotic water retention in the colon and promoting softer stools and colonic motility.',
    ...
    pediatricUse: 'The 2026 ESPGHAN/NASPGHAN guideline lists lactulose at 350–700 mg/kg/day for neonates and infants through 6 months, and 0.6–2 g/kg/day for 7 months–18 years, given once daily or in 2 divided doses. DoseCare encodes the non-overlapping age boundaries as 0–6 months and 7–18 years. Current DailyMed labeling for the selected 10 g/15 mL product states that pediatric safety and effectiveness have not been established; therefore these DoseCare regimens are explicitly guideline-based rather than product-label pediatric dosing.',
  ...
  sources: [
    ...
    { organization: 'DailyMed', title: 'Lactulose Solution USP 10 g/15 mL — current labeling; pediatric safety/effectiveness not established', url: 'https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=8b79d0d6-b9e3-436e-bab7-01451b6f45cd' }
  ]
});
