...
window.DoseCareV2Database?.register({
  ...
  information: {
    ...
    mechanismOfAction: 'As a laxative, magnesium hydroxide increases water in the intestinal lumen and promotes bowel evacuation. As an antacid, it neutralizes gastric acid.',
