 ...
 * Formulation evidence: Nationwide Children's Hospital pediatric GERD guideline lists omeprazole suspension 2 mg/mL.
 * Dosing cross-checked against NASPGHAN/ESPGHAN pediatric GERD guideline and AAP pediatric GERD guidance.
 */
window.DoseCareV2Database?.register({
  ...
  information: {
    ...
    mechanismOfAction: 'Irreversibly inhibits the gastric proton pump (H+/K+-ATPase), reducing basal and stimulated gastric acid secretion.',
