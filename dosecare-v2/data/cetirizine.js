...
window.DoseCareV2Database?.register({
  ...
  regimens: [
    ...
    {
      id: 'allergic-rhinitis-urticaria-12m-23m-max-q12h',
      type: 'fixed_dose',
      ...
      doseUnit: 'mg/dose',
      frequency: 2,
      frequencyText: 'Every 12 hours; maximum 5 mg/day',
      minAgeMonths: 12,
      maxAgeMonths: 23,
      maximumDailyDose: 5,
      requiresAge: true,
    ...
    {
      id: 'chronic-urticaria-2y-5y-max-once-daily',
      type: 'fixed_dose',
      ...
      doseUnit: 'mg/dose',
      frequency: 1,
      frequencyText: 'Every 24 hours; maximum 5 mg/day',
      minAgeYears: 2,
      maxAgeYears: 5.999,
      maximumDailyDose: 5,
      requiresAge: true,
    ...
    {
      id: 'chronic-urticaria-2y-5y-max-q12h',
      type: 'fixed_dose',
    ...
    },
    {
      ...
      doseUnit: 'mg/dose',
      frequency: 1,
      frequencyText: 'Every 24 hours; maximum 10 mg/day',
      minAgeYears: 6,
      maximumDailyDose: 10,
      requiresAge: true,
      requiresWeight: false,
  ...
  information: {
    ...
    sources: [
      { organization: 'DailyMed', title: 'Cetirizine Hydrochloride Oral Solution USP 1 mg/mL — pediatric dosing, effective 2026', url: 'https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=e874264a-becc-45d0-b934-779eab5f5085' },
