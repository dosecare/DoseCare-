...
DoseCareV2Database.register({
  ...
  information: {
    ...
    notes: 'The encoded regimens are limited to the pediatric age/weight scope supported by the selected prescribing information. A separate infant rule was removed because it could not be attributed confidently to the exact Amoxicillin-only label selected for this record.'
  },
  sources: [
