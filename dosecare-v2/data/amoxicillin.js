...
DoseCareV2Database.register({
  ...
  information: {
    ...
    indications: ['Treatment of susceptible bacterial infections for which the labeled regimen is appropriate'],
    ...
    notes: 'The pediatric regimens encoded here apply to patients aged 3 months and older and weighing less than 40 kg. The referenced label provides separate regimens by infection category/severity and dosing interval.'
  },
  sources: [
    { organization: 'DailyMed', title: 'Amoxicillin for Oral Suspension — 400 mg/5 mL', url: 'https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=81fe142e-a163-4632-93fb-7cd8d80c50bd' },
    { organization: 'DailyMed', title: 'Amoxicillin for Oral Suspension — Dosage Recommendations', url: 'https://dailymed.nlm.nih.gov/dailymed/getFile.cfm?setid=1b9c0a98-2a31-4b23-ac4f-7c3f14b6f92f' }
  ]
});
