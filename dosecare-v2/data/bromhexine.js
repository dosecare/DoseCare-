...
window.DoseCareV2Database?.register({
  ...
  information: {
    ...
    indications: ['Management of viscid mucoid secretions associated with bronchitis, bronchiectasis and sinusitis'],
    mechanism: 'Bromhexine is a mucolytic agent used to reduce the viscosity of respiratory secretions and facilitate mucus clearance.',
    precautions: ['Use with caution in patients with a history of or existing peptic ulceration.', 'Rare serious skin reactions have been reported; discontinue treatment if a progressive skin rash occurs and seek medical assessment.', 'Use the supplied measuring device to ensure accurate dosing.'],
    ...
    administration: 'For oral use. The cited 4 mg/5 mL oral solution may be taken with or without food.',
    pediatricUse: 'For the selected 4 mg/5 mL oral solution: children 2–5 years receive 5 mL (4 mg) twice daily; children over 5 through 12 years receive 5 mL (4 mg) four times daily. DoseCare does not extrapolate a pediatric dose below 2 years because the cited product information does not provide one.',
    notes: 'The selected HPRA-authorised product is an oral solution. Tablet, capsule and injectable formulations are excluded from DoseCare.'
  },
  sources: [
