  ...
  regimens: [
    {
      ...
      frequency: 1, frequencyText: '4 mg 30 minutes before chemotherapy, then 4 mg at 4 and 8 hours after the first dose',
    ...
    },
    {
      ...
      type: 'fixed_dose', dose: 4, minDose: 4, maxDose: 4, unit: 'mg/dose',
      frequency: 3, frequencyText: '4 mg three times daily (every 8 hours) for 1–2 days after chemotherapy',
      requiresAge: true, requiresWeight: false, minAgeYears: 4, maxAgeYears: 11
    },
    {
      ...
      frequency: 1, frequencyText: '8 mg 30 minutes before chemotherapy, then 8 mg 8 hours after the first dose',
    ...
    },
    {
      ...
      condition: 'Moderately emetogenic chemotherapy — post-chemotherapy phase',
      type: 'fixed_dose', dose: 8, minDose: 8, maxDose: 8, unit: 'mg/dose',
      frequency: 2, frequencyText: '8 mg twice daily (every 12 hours) for 1–2 days after chemotherapy',
      requiresAge: true, requiresWeight: false, minAgeYears: 12, maxAgeYears: 17
    }
  ],
  information: {
    ...
    administration: 'Administer the oral solution using an accurate oral measuring device. For chemotherapy, select the appropriate initial or post-chemotherapy phase rather than treating the full course as one fixed frequency.',
