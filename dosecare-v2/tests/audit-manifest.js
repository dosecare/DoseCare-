window.DoseCareV2Audit = (() => {
  const expectedIds = [
    ...
    'lactulose','omeprazole','magnesium-hydroxide','famotidine','sulfamethoxazole-trimethoprim','zinc-sulfate','domperidone','simethicone','hyoscine-butylbromide','vitamin-d3','iron','multivitamin','folic-acid'
  ];
